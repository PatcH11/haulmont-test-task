...
public class PaymentScheduleGetDto {

    private UUID id;
    private CreditOfferGetDto creditOffer;
    private Date date;
    ...
    public CreditOfferGetDto getCreditOffer() {
        return creditOffer;
    }

    public void setCreditOffer(CreditOfferGetDto creditOffer) {
    ...
    public boolean equals(Object o) {
        ...
        PaymentScheduleGetDto that = (PaymentScheduleGetDto) o;
